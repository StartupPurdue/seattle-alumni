$(document).ready(() => {
  ...
  const startAirtable = () => {
    ...
    .then(res => {
      ...
      data.forEach(result => resultsContainer.append(buildUser(result)));
  ...
  const search = () => {
    ...
    results.forEach(result => {
      resultsContainer.append(buildUser(result))
    })
  }
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">${userData.Role} at <b>${userData.Company}</b></p>
            <p class="card-text grad">Computer Science '17</p>
          </div>
          <div class="card-footer">
            <a href="mailto:startuppurdue@gmail.com" class="card-link text-center">Contact</a>
          </div>
        </div>
      </div>
    `;
